...
export default function Info() {
    return (
        <div className="md:flex md:flex-wrap ">
            ...
            <div className="md:flex-1 m-2 rounded-lg p-5 cursor-pointer mr-10 bg-gradient-to-r from-blue-600 to-blue-200" >
            ...
            <div className="md:flex-1 m-2 rounded-lg p-5 cursor-pointer mr-10   bg-gradient-to-r from-green-500  to-green-100" >
            ...
            <div className="md:flex-1 m-2 rounded-lg p-5 cursor-pointer mr-10  border-black bg-gradient-to-r from-yellow-500  to-yellow-100" >
